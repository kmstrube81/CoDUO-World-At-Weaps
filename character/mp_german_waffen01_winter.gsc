...

{
	...
	self.hatModel = character\_utility::randomElement(xmodelalias\headwear_waffen_winter::main());
...

{
	...
	character\_utility::precacheModelArray(xmodelalias\headwear_waffen_winter::main());
