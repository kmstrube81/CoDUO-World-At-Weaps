...

{
	...
	self.hatModel = character\_utility::randomElement(xmodelalias\headwear_wehrmacht::main());
...

{
	...
	character\_utility::precacheModelArray(xmodelalias\headwear_wehrmacht::main());
