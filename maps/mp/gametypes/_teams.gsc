...
precache()
{
	...
	/////////////////////////////////////////////////
	//MADE ALL WEAPONS AVAILABLE TO ALL FACTIONS
	/////////////////////////////////////////////////
	...
	precacheItem("sten_silenced_mp"); //ADDED STEN PRECACHE
	...
	precacheItem("cocktail_mp");
	precacheItem("mustardgas_mp");
	precacheItem("silencedpistol_mp");
	precacheItem("m712_mp");
	precacheItem("m2_mp");
	precacheItem("m3_mp");
	precacheItem("scopedm1garand_mp");
	precacheItem("m1garand_g_mp");
	precacheItem("gewehr43_scoped_mp");
	precacheItem("gewehr43_g_mp");
	precacheItem("svt40_scoped_mp");
	//new smgs
	precacheItem("tommy_mp");
	precacheItem("tommy2_mp");
	precacheItem("greasegun_mp");
	precacheItem("pps43_mp");
	precacheItem("mp40_silenced_mp");
	//new mgs
	precacheItem("scopedmp44_mp");
	precacheItem("fg42_scoped_mp");
	//new lmgs
	precacheItem("mg42_mp");
	precacheItem("trenchgun_mp");
	//new snipers
	precacheItem("m1903a3_mp");
	precacheItem("enfieldscoped_mp");
	precacheItem("delisle_mp");
	precacheItem("ptrs_mp");
	//new satchel
	precacheItem("german_smoke_mp");
	precacheItem("panzerschreck_equip_mp");
	precacheItem("panzerfaust_equip_mp");
	precacheItem("bazooka_equip_mp");
	precacheItem("flamethrower_equip_mp");
...
getWeaponLoadoutScore(weapon)
{
	switch(weapon){
	/////////////////////////////////////////////////////////
	// lmgs (besides dp) and ptrs cost 3 loadout points
	/////////////////////////////////////////////////////////
		case "mg30cal_mp":
			points = level.cost_mg30cal;
			break;
		case "mg34_mp":
			points = level.cost_mg34;
			break;
		case "mg42_mp":
			points = level.cost_mg42;
			break;
		case "ptrs_mp":
			points = level.cost_ptrs;
			break;
	//////////////////////////////////////////////////////////////////////
	// scoped, silenced, drum weapons and equipment cost 2 loadout points
	// also webley, trenchgun, and dp
	//////////////////////////////////////////////////////////////////////
		case "scopedm1garand_mp":
			points = level.cost_m1garand_sniper;
			break;
		case "scopedmp44_mp":
			points = level.cost_scopedmp44;
			break;
		case "fg42_scoped_mp":
			points = level.cost_fg42_scoped;
			break;
		case "gewehr43_scoped_mp":
			points = level.cost_gewehr43_sniper;
			break;
		case "gewehr43_g_mp":
			points = level.cost_gewehr43_grenade;
			break;
		case "m1garand_g_mp":
			points = level.cost_m1garand_grenade;
			break;
		case "svt40_scoped_mp":
			points = level.cost_svt40_sniper;
			break;
		case "m3_mp":
			points = level.cost_m3carbine;
			break;
		case "kar98k_sniper_mp":
			points = level.cost_kar98ksniper;
			break;
		case "mosin_nagant_sniper_mp":
			points = level.cost_nagantsniper;
			break;
		case "enfieldscoped_mp":
			points = level.cost_enfield_sniper;
			break;
		case "mp40_silenced_mp":
			points = level.cost_mp40_silenced;
			break;
		case "tommy2_mp":
			points = level.cost_thompson_silenced;
			break;
		case "delisle_mp":
			points = level.cost_delisle;
			break;
		case "silencedpistol_mp":
			points = level.cost_welrod;
			break;
		case "sten_silenced_mp":
			points = level.cost_sten_silenced;
			break;
		case "tommy_mp":
			points = level.cost_thompson_drum;
			break;
		case "ppsh_mp":
			points = level.cost_ppsh;
			break;
		case "webley_mp":
			points = level.cost_webley;
			break;
		case "trenchgun_mp":
			points = level.cost_trenchgun;
			break;
		case "dp28_mp":
			points = level.cost_dp28;
			break;
		case "m2_mp":
			points = level.cost_m2carbine;
			break;
		case "m712_mp":
			points = level.cost_m712;
			break;
		case "satchelcharge_mp":
			points = level.cost_satchelcharge;
			break;
		case "german_smoke_mp":
			points = level.cost_geballte;
			break;
		case "panzerschreck_equip_mp":
			points = level.cost_panzerschreck;
			break;
		case "bazooka_equip_mp":
			points = level.cost_bazooka;
			break;
		case "flamethrower_equip_mp":
			points = level.cost_flamethrower;
			break;
	///////////////////////////////////////////////
	// Most weapons cost a single point
	///////////////////////////////////////////////
		case "m1carbine_mp":
			points = level.cost_m1carbine;
			break;
		case "m1garand_mp":
			points = level.cost_m1garand;
			break;
		case "gewehr43_mp":
			points = level.cost_gewehr43;
			break;
		case "svt40_mp":
			points = level.cost_svt40;
			break;
		case "thompson_mp":
			points = level.cost_thompson;
			break;
		case "greasegun_mp":
			points = level.cost_greasegun;
			break;
		case "sten_mp":
			points = level.cost_sten;
			break;
		case "pps43_mp":
			points = level.cost_pps43;
			break;
		case "mp40_mp":
			points = level.cost_mp40;
			break;
		case "bar_mp":
			points = level.cost_bar;
			break;
		case "bren_mp":
			points = level.cost_bren;
			break;
		case "mp44_mp":
			points = level.cost_mp44;
			break;
		case "fg42_mp":
			points = level.cost_fg42;
			break;
		case "m1903a3_mp":
			points = level.cost_m1903a3;
			break;
		case "enfield_mp":
			points = level.cost_enfield;
			break;
		case "mosin_nagant_mp":
			points = level.cost_nagant;
			break;
		case "kar98k_mp":
			points = level.cost_kar98k;
			break;
		case "colt_mp":
			points = level.cost_colt;
			break;
		case "tt33_mp":
			points = level.cost_tt33;
			break;
		case "luger_mp":
			points = level.cost_luger;
			break;
		case "fraggrenade_mp":
			points = level.cost_fraggrenade;
			break;
		case "mk1britishfrag_mp":
			points = level.cost_mk1britishfraggrenade;
			break;
		case "rgd-33russianfrag_mp":
			points = level.cost_rgd33russianfraggrenade;
			break;
		case "stielhandgranate_mp":
			points = level.cost_stielhandgranate;
			break;
		case "smokegrenade_mp":
			points = level.cost_smokegrenade;
			break;
		case "cocktail_mp":
			points = level.cost_molotov;
			break;
		case "mustardgas_mp":
			points = level.cost_mustardgas;
			break;
		////////////////////////////////////////////
		// perks
		///////////////////////////////////////////
		...
		case "extra_grenade_perk":
			points = level.cost_extra_grenade;
			break;
...
{
	////////////////////////////////////////////
	// FIRST CHECK THAT WEAPON ISN'T RESTRICTED
	////////////////////////////////////////////
	switch(response)		
		{
		//none responses automatically validate
		case "nonePistol":
		case "noneGrenade":
		case "noneSmoke":
		case "noneSatchel":
		...
		case "firebomb":
			return response;
		case "m1carbine_mp":
			if(!getcvar("scr_allow_rifles") || !getcvar("scr_allow_m1carbine") || !getcvar("scr_allow_uscarbine"))
			{
		...
		//////////////////////////////////////////////
		case "m2_mp":
			if(!getcvar("scr_allow_rifles") || !getcvar("scr_allow_m2carbine") || !getcvar("scr_allow_uscarbine"))
			{
				self iprintln("The M2 Carbine is a restricted weapon.");
				response = "restricted";
			}
			break;
		...
		//////////////////////////////////////////////
		case "m3_mp":
			if(!getcvar("scr_allow_rifles") || !getcvar("scr_allow_m3carbine") || !getcvar("scr_allow_uscarbine"))
			{
				self iprintln("The M3 Carbine is a restricted weapon.");
				response = "restricted";
			}
			break;
			
		case "m1garand_mp":
			if(!getcvar("scr_allow_rifles") || !getcvar("scr_allow_m1garand") || !getcvar("scr_allow_m1garand_none"))
			{
		...
		////////////////////////////////////////////////
		// ADDED SCOPED M1 GARAND
		////////////////////////////////////////////////
		case "scopedm1garand_mp":
			if(!getcvar("scr_allow_rifles") || !getcvar("scr_allow_m1garand_sniper") || !getcvar("scr_allow_m1garand"))
			{
				self iprintln("The Scoped M1 Garand is a restricted weapon.");
				response = "restricted";
			}
			break;
			
		////////////////////////////////////////////////
		// ADDED NUBE TUBE M1 GARAND
		///////////////////////////////////////////////
		case "m1garand_g_mp":
			if(!getcvar("scr_allow_rifles") || !getcvar("scr_allow_m1garand_grenade") || !getcvar("scr_allow_m1garand"))
			{
				self iprintln("The M1 Garand (Rifle Grenade) is a restricted weapon.");
				response = "restricted";
			}
			break;
			
		case "thompson_mp":
			if(!getcvar("scr_allow_smgs") || !getcvar("scr_allow_thompson") || !getcvar("scr_allow_thompson_none"))
			{
		...
		///////////////////////////////////////////////
		case "tommy2_mp":
			if(!getcvar("scr_allow_smgs") || !getcvar("scr_allow_thompson_silenced") || !getcvar("scr_allow_thompson"))
			{
				self iprintln("The Silenced Thompson is a restricted weapon.");
				response = "restricted";
			}
			break;
		...
		///////////////////////////////////////////////
		case "tommy_mp":
			if(!getcvar("scr_allow_smgs") || !getcvar("scr_allow_thompson_drum") || !getcvar("scr_allow_thompson"))
			{
				self iprintln("The M1928 Thompson is a restricted weapon.");
				response = "restricted";
			}
			break;
		...
		///////////////////////////////////////////////
		case "greasegun_mp":
			if(!getcvar("scr_allow_smgs") || !getcvar("scr_allow_greasegun"))
			{
				self iprintln("The Grease Gun is a restricted weapon.");
				response = "restricted";
			}
			break;

		case "bar_mp":
			if(!getcvar("scr_allow_mgs") || !getcvar("scr_allow_bar"))
			{
		...
		///////////////////////////////////////////////////
		case "m1903a3_mp":
			if(!getcvar("scr_allow_snipers") || !getcvar("scr_allow_m1903a3") || !getcvar("scr_allow_springfield"))
			{
		...
		case "springfield_mp":
			if(!getcvar("scr_allow_snipers") || !getcvar("scr_allow_springfield") || !getcvar("scr_allow_springfield_scoped"))
			{
				self iprintln(&"MPSCRIPT_SPRINGFIELD_IS_A_RESTRICTED");
				response = "restricted";
			}
		...
		case "mg30cal_mp":
			if(!getcvar("scr_allow_heavies") || !getcvar("scr_allow_mg30cal"))
			{
		...
		/////////////////////////////////////////////////
		case "trenchgun_mp":
			if(!getcvar("scr_allow_heavies") || !getcvar("scr_allow_trenchgun"))
			{
				self iprintln("The Trenchgun is a restricted weapon.");
				response = "restricted";
			}
			break;
			
		case "enfield_mp":
			if(!getcvar("scr_allow_snipers") || !getcvar("scr_allow_enfield") || !getcvar("scr_allow_enfield_none"))
			{
		...
		case "enfieldscoped_mp":
			if(!getcvar("scr_allow_snipers") || !getcvar("scr_allow_enfield_sniper") || !getcvar("scr_allow_enfield"))
			{
				self iprintln("The Scoped Lee-Enfield is a restricted weapon.");
				response = "restricted";
			}
			break;
			
		///////////////////////////////////////
		// ADDED DELISLE SILENCED
		///////////////////////////////////////
		case "delisle_mp":
			if(!getcvar("scr_allow_smgs") || !getcvar("scr_allow_delisle"))
			{
				self iprintln("The De Lisle Carbine is a restricted weapon.");
				response = "restricted";
			}
			break;
			
		case "sten_mp":
			if(!getcvar("scr_allow_smgs") || !getcvar("scr_allow_sten") || !getcvar("scr_allow_sten_none"))
			{
		...
		///////////////////////////////////////
		case "sten_silenced_mp":
			if(!getcvar("scr_allow_smgs") || !getcvar("scr_allow_sten_silenced") || !getcvar("scr_allow_sten"))
			{
				self iprintln(&"MPSCRIPT_STEN_IS_A_RESTRICTED");
				response = "restricted";
			}
		...
		case "bren_mp":
			if(!getcvar("scr_allow_mgs") || !getcvar("scr_allow_bren"))
			{
		...
		case "mosin_nagant_mp":
			if(!getcvar("scr_allow_snipers") || !getcvar("scr_allow_nagant") || !getcvar("scr_allow_nagant_none"))
			{
		...
		case "svt40_mp":
			if(!getcvar("scr_allow_rifles") || !getcvar("scr_allow_svt40") || !getcvar("scr_allow_svt40_none"))
			{
		...
		////////////////////////////////////////////
		case "svt40_scoped_mp":
			if(!getcvar("scr_allow_rifles") || !getcvar("scr_allow_svt40_sniper") || !getcvar("scr_allow_svt40"))
			{
				self iprintln("The Scoped SVT40 is a restricted weapon.");
				response = "restricted";
			}
			break;
			
		case "ppsh_mp":
			if(!getcvar("scr_allow_smgs") || !getcvar("scr_allow_ppsh"))
			{
		...
		//////////////////////////////////////////////
		case "pps43_mp":
			if(!getcvar("scr_allow_smgs") || !getcvar("scr_allow_pps43"))
			{
				self iprintln("The PPS43 is a restricted weapon.");
				response = "restricted";
			}
			break;
			
		case "mosin_nagant_sniper_mp":
			if(!getcvar("scr_allow_snipers") || !getcvar("scr_allow_nagantsniper") || !getcvar("scr_allow_nagant"))
			{
		...
		//////////////////////////////////////////////////
		case "ptrs_mp":
			if(!getcvar("scr_allow_snipers") || !getcvar("scr_allow_ptrs"))
			{
				self iprintln("The PTRS is a restricted weapon!");
				response = "restricted";
			}
			break;
			
		case "dp28_mp":
			if(!getcvar("scr_allow_heavies") || !getcvar("scr_allow_dp28"))
			{
		...
		case "kar98k_mp":
			if(!getcvar("scr_allow_snipers") || !getcvar("scr_allow_kar98k") || !getcvar("scr_allow_kar98k_none"))
			{
		...
		case "gewehr43_mp":
			if(!getcvar("scr_allow_rifles") || !getcvar("scr_allow_gewehr43") || !getcvar("scr_allow_gewehr43_none"))
			{
		...
		///////////////////////////////////////////////
		case "gewehr43_scoped_mp":
			if(!getcvar("scr_allow_rifles") || !getcvar("scr_allow_gewehr43_sniper") || !getcvar("scr_allow_gewehr43"))
			{
				self iprintln("The Scoped Gewehr43 is a restricted weapon.");
				response = "restricted";
			}
			break;
		...
		///////////////////////////////////////////////
		case "gewehr43_g_mp":
			if(!getcvar("scr_allow_rifles") || !getcvar("scr_allow_gewehr43_grenade") || !getcvar("scr_allow_gewehr43"))
			{
				self iprintln("The Gewehr43 (Rifle Grenade) is a restricted weapon.");
				response = "restricted";
			}
			break;
			
		case "mp40_mp":
			if(!getcvar("scr_allow_smgs") || !getcvar("scr_allow_mp40") || !getcvar("scr_allow_mp40_none"))
			{
		...
		///////////////////////////////////////////////
		case "mp40_silenced_mp":
			if(!getcvar("scr_allow_smgs") || !getcvar("scr_allow_mp40_silenced") || !getcvar("scr_allow_mp40"))
			{
				self iprintln("The Silenced MP40 is a restricted weapon.");
				response = "restricted";
			}
			break;
			
		case "mp44_mp":
			if(!getcvar("scr_allow_mgs") || !getcvar("scr_allow_mp44") || !getcvar("scr_allow_mp44_none"))
			{
		...
		///////////////////////////////////////////////////////////////
		case "scopedmp44_mp":
			if(!getcvar("scr_allow_mgs") || !getcvar("scr_allow_scopedmp44") || !getcvar("scr_allow_mp44"))
			{
				self iprintln("The Scoped MP44 is a restricted weapon.");
				response = "restricted";
			}
			break;
			
		case "kar98k_sniper_mp":
			if(!getcvar("scr_allow_snipers") || !getcvar("scr_allow_kar98ksniper") || !getcvar("scr_allow_kar98k"))
			{
		...
		case "mg34_mp":
			if(!getcvar("scr_allow_heavies") || !getcvar("scr_allow_mg34"))
			{
		...
		///////////////////////////////////////
		case "mg42_mp":
			if(!getcvar("scr_allow_heavies") || !getcvar("scr_allow_mg42_mp"))
			{
				self iprintln("The MG42 is a restricted weapon.");
				response = "restricted";
			}
			break;
		...
		//////////////////////////////////////
		case "fg42_mp":
			if(!getcvar("scr_allow_mgs") || !getcvar("scr_allow_fg42") || !getcvar("scr_allow_fg42_none"))
			{
				self iprintln(&"GMI_WEAPON_FG42_IS_A_RESTRICTED");
				response = "restricted";
			}
			break;	
		...
		//////////////////////////////////////
		case "fg42_scoped_mp":
			if(!getcvar("scr_allow_mgs") || !getcvar("scr_allow_fg42_scoped") || !getcvar("scr_allow_fg42"))
			{
				self iprintln("The Scoped FG42 is a restricted weapon.");
				response = "restricted";
			}
			break;
		...
		//////////////////////////////////////
		case "colt_mp":
			if(!getcvar("scr_allow_pistols") || !getcvar("scr_allow_colt"))
			{
				self iprintln("The Colt M1911 is a Restricted Weapon");
				response = "restricted";
			}
			break;
		
		case "luger_mp":
			if(!getcvar("scr_allow_pistols") || !getcvar("scr_allow_luger"))
			{
				self iprintln("The Luger is a Restricted Weapon");
				response = "restricted";
			}
			break;
			
		case "webley_mp":	
			if(!getcvar("scr_allow_pistols") || !getcvar("scr_allow_webley"))
			{
				self iprintln("The Webley Mk IV is a Restricted Weapon");
				response = "restricted";
			}
			break;
			
		case "tt33_mp":	
			if(!getcvar("scr_allow_pistols") || !getcvar("scr_allow_tt33"))
			{
				self iprintln("The Tokarev TT33 is a Restricted Weapon");
				response = "restricted";
			}
			break;
			
		case "silencedpistol_mp":	
			if(!getcvar("scr_allow_pistols") || !getcvar("scr_allow_welrod"))
			{
				self iprintln("The Welrod Silenced Pistol is a Restricted Weapon");
				response = "restricted";
			}
			break;
			
		case "m712_mp":	
			if(!getcvar("scr_allow_pistols") || !getcvar("scr_allow_m712"))
			{
				self iprintln("The Mauser M712 is a Restricted Weapon");
				response = "restricted";
			}
			break;
		...
		/////////////////////////////////
		case "fraggrenade_mp":
			if(!getcvar("scr_allow_grenades") || !getcvar("scr_allow_fraggrenade"))
			{
				self iprintln("The Mk2 Frag Grenade is a Restricted Weapon");
				response = "restricted";
			}
			break;
			
		case "mk1britishfrag_mp":
			if(!getcvar("scr_allow_grenades") || !getcvar("scr_allow_mk1britishfraggrenade"))
			{
				self iprintln("The Mk1 British Frag Grenade is a Restricted Weapon");
				response = "restricted";
			}
			break;
		
		case "rgd-33russianfrag_mp":		
			if(!getcvar("scr_allow_grenades") || !getcvar("scr_allow_rgd33russianfraggrenade"))
			{
				self iprintln("The RGD-33 Stick Grenade is a Restricted Weapon");
				response = "restricted";
			}
			break;
		
		case "stielhandgranate_mp":
			if(!getcvar("scr_allow_grenades") || !getcvar("scr_allow_stielhandgranate"))
			{
				self iprintln("The Stielhandgranate is a Restricted Weapon");
				response = "restricted";
			}
			break;
		...
		/////////////////////////////////
		case "smokegrenade_mp":
			if(!getcvar("scr_allow_smoke") || !getcvar("scr_allow_smokegrenade"))
			{
				self iprintln("The Smoke Grenade is a Restricted Weapon");
				response = "restricted";
			}
			break;
			
		case "cocktail_mp":
			if(!getcvar("scr_allow_smoke") || !getcvar("scr_allow_molotov"))
			{
				self iprintln("The Molotov Cocktail is a Restricted Weapon");
				response = "restricted";
			}
			break;
			
		case "mustardgas_mp":
			if(!getcvar("scr_allow_smoke") || !getcvar("scr_allow_mustardgas"))
			{
				self iprintln("The Gas Grenade is a Restricted Weapon");
				response = "restricted";
			}
			break;
		...
		//////////////////////////////////
		case "satchelcharge_mp":
			if(!getcvar("scr_allow_satchel") || !getcvar("scr_allow_satchelcharge"))
			{
				self iprintln("The Satchel Charge is a Restricted Weapon");
				response = "restricted";
			}
			break;
			
		case "german_smoke_mp":
			if(!getcvar("scr_allow_satchel") || !getcvar("scr_allow_geballte"))
			{
				self iprintln("The Geballte Lathing is a Restricted Weapon");
				response = "restricted";
			}
			break;
		////////////////////////////////////
		// ADDED EQUIPMENT SLOT PANZERFAUST
		////////////////////////////////////
		case "panzerfaust_equip_mp":
			if(!getcvar("scr_allow_satchel") || !getcvar("scr_allow_panzerfaust"))
			{
				self iprintln("The Panzerfaust is a Restricted Weapon.");
				response = "restricted";
			}
			break;
			
		////////////////////////////////////
		// ADDED EQUIPMENT SLOT PANZERSCHRECK
		////////////////////////////////////
		case "panzerschreck_equip_mp":
			if(!getcvar("scr_allow_satchel") || !getcvar("scr_allow_panzerschreck"))
			{
				self iprintln("The Panzerschreck is a Restricted Weapon.");
				response = "restricted";
			}
			break;
			
		////////////////////////////////////
		// ADDED EQUIPMENT SLOT BAZOOKA
		////////////////////////////////////
		case "bazooka_equip_mp":
			if(!getcvar("scr_allow_satchel") || !getcvar("scr_allow_bazooka"))
			{
				self iprintln("The Bazooka is a Restricted Weapon.");
				response = "restricted";
			}
			break;
		
		////////////////////////////////////
		// ADDED EQUIPMENT SLOT FLAMETHROWER
		////////////////////////////////////
		case "flamethrower_equip_mp":
			if(!getcvar("scr_allow_satchel") || !getcvar("scr_allow_flamethrower"))
			{
				self iprintln("The Flamethrower is a Restricted Weapon.");
				response = "restricted";
			}
			break;
			
		/////////////////////////////////////
		// ADDED EXTRA EQUIPMENT PERKS
		/////////////////////////////////////
		case "extra_equipment_perk":
			if(!getcvar("scr_allow_perks") || !getcvar("scr_allow_tier1_perks") || !getcvar("scr_allow_extra_equipment"))
			{
				self iprintln("The extra Equipment perk is restricted.");
				response = "restricted";
			}
			break;
		...
		case "extra_smoke_perk":
			...
			{
				self iprintln("The extra Special Grenades perk is restricted.");
				response = "restricted";
			}
			break;
			
		case "extra_grenade_perk":
			if(!getcvar("scr_allow_perks") || !getcvar("scr_allow_tier2_perks") || !getcvar("scr_allow_extra_grenade"))
			{
				self iprintln("The extra Grenades perk is restricted.");
				response = "restricted";
			}
			break;
			
		case "extra_ammo_perk":
			if(!getcvar("scr_allow_perks") || !getcvar("scr_allow_tier2_perks") || !getcvar("scr_allow_extra_ammo"))
			{
				self iprintln("The extra ammo perk is restricted.");
				response = "restricted";
			}
			break;
	...
	//////////////////////////////////////////////////////////
	// NEXT CHECK LOADOUT POINTS WOULDN'T GO OVER MAX
	////////////////////////////////////////////////////////
	switch(maps\mp\gametypes\_loadout_gmi::getLoadoutSlot(response)){
		case "primary":
	...
	newScore = getWeaponLoadoutScore(response);
	currScore = getWeaponLoadoutScore(slot);
	difference = newScore - currScore;
	loadout_score = self.pers["loadout_score"] + difference;
	
	if(loadout_score > self.pers["loadout_points"]){
		self iprintln("You don't have enough loadout points!");
		maps\mp\gametypes\_waw::printDebug("Total Loadout Points: " + self.pers["loadout_points"],"info","self");
		maps\mp\gametypes\_waw::printDebug("Current Loadout Score is " + self.pers["loadout_score"],"info", "self");
		maps\mp\gametypes\_waw::printDebug(response + " (new weapon) is worth " + newScore, "info", "self");
		maps\mp\gametypes\_waw::printDebug(slot + " (old weapon) is worth " + currScore, "info", "self");
		maps\mp\gametypes\_waw::printDebug(newScore + " - " + oldScore + " = " + difference, "info", "self");
		maps\mp\gametypes\_waw::printDebug("Loadout Score would be " + loadout_score, "info", "self");
		self setClientCvar("player_loadout_warning", "^1You ^1don't ^1have ^1enough ^1loadout ^1points!");
		response = "restricted";
	}
