...
///////////////////////////////////////////////////////////////
IN MAIN FUNCTION - ADD CVAR FOR LOADOUT POINTS
///////////////////////////////////////////////////////////////
...
IN PLAYER CONNECT FUNCTION-
	...
	AND COMMENT OUT LOADOUT CLEAR LINE ON SPECTATE AND ADD FOLLOWING LINE
	self.pers["firstspawn"] = false;
...
self maps\mp\gametypes\_loadout_gmi::updateDefaultLoadout(game["axis"]);
	...
	CHANGE NEW WEAPON HANDLING CONDITION
else if( maps\mp\gametypes\_newmenus::isWeaponMenu(menu) )

	ADD CONFIRM SPAWN LOGIC
if(response == "confirm"){
	menu_spawn(weapon);
}
...
//IN END MAP FUNCTION
//////////////////////////////////
ADD THIS FOR MAP VOTE
		maps\mp\gametypes\_mapvote::Initialize();
ADD THIS UNDER PLAYERS LOOP
		player.pers["loadout_score"] = 0;
		player.pers["loadout_points"] = level.default_loadout_points;
///////////////////////////////////////
///IN UPDATE GAMETYPE CVARS FUNCTION
//////////////////////////////////////
